test_that("tests from nhsnumber package", {
...
test_that("tests from nhsnumber package but with NA", {
    ...
    #expect_identical(is_valid_mod11(dat_1), expected_1)
    expect_identical(is_valid_mod11(dat_1), expected_2)
})
...
test_that("tests from generator tweaked by one", {
    ...
    expected_3 <- logical(length(dat_3))
